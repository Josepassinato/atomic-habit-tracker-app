-- 1. Adicionar colunas necessárias à tabela user_profiles existente
...
-- 5. Atualizar policies de perfis para isolamento adequado
...
-- 6. Atualizar policies de hábitos para isolamento por empresa
...
-- 7. Atualizar policies de metas para isolamento por empresa
...
-- 8. Atualizar policies de vendedores para isolamento por empresa
...
-- 9. Atualizar policies de equipes para isolamento por empresa
...
CREATE INDEX IF NOT EXISTS idx_habits_team_id ON public.habits(team_id);
CREATE INDEX IF NOT EXISTS idx_goals_team_id ON public.goals(team_id);
CREATE INDEX IF NOT EXISTS idx_sales_reps_company_id ON public.sales_reps(company_id);
