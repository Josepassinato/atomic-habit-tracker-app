...
export const es = {
  ...
  'defaultAiSuggestion': 'Concéntrese en la meta de conversión aumentando el número de seguimientos para cada cliente potencial calificado.',
  'mainGoal': 'Meta Principal',
  'prospectingGoal': 'Meta de Prospección',
